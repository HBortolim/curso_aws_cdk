...
public class InvoiceStack extends Stack {
    ...
    public InvoiceStack(final Construct scope, final String id) {
        this(scope, id, null);
    }

    public InvoiceStack(final Construct scope, final String id, final StackProps props) {
        super(scope, id, props);


        SnsTopic s3InvoiceTopic = SnsTopic.Builder.create(Topic.Builder.create(this, "S3InvoiceTopic")
                .topicName("s3-invoice-vents")
                .build())
                .build();
        ...
        Queue s3InvoiceDlq = Queue.Builder.create(this, "S3InvoiceDlq")
                .queueName("s3-invoice-events-dql")
                .build();
