...
public class SnsStack extends Stack {
    ...
    public SnsStack(final Construct scope, final String id, final StackProps props) {
        ...
        productEventsTopic = software.amazon.awscdk.services.events.targets.SnsTopic.Builder.create(
                Topic.Builder.create(this, "ProductEventsTopic")
                        .topicName("product-events")
                        .build())
                .build();

        productEventsTopic.getTopic().addSubscription(EmailSubscription.Builder.create("hbortolim@gmail.com")
                .json(true)
                .build());
    }
